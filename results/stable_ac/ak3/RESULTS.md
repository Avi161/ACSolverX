...
Code lives in `experiments/stable_ac/cov/ak3/`, artifacts (this file, both certificates, the sweep jsonl) in `results/stable_ac/ak3/`, and the tests in `tests/stable_ac/test_ak3.py`.
...
`PYTHONHASHSEED=0 .venv/bin/python3 -m experiments.stable_ac.cov.ak3.<sweep|census|analyze|ball>`
