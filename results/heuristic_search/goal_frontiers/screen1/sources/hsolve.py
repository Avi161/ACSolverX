...
has a lesson to that effect. The moves come out of the expansion kernel that generated them.
    ...
    from experiments.heuristic_search.core.hsolve import greedy_search_h, S20_MK2
...
from experiments.search.heuristics import BASELINE_CONFIG as LENGTH_ONLY, S20_MK2
