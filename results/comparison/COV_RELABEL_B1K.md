...
| `(abel)` + relabel-dedup + S | 36 | 41 | 19 | 218.9 | 65,975 | 0 |
...
| `(abel, total)` + relabel-dedup + S | 40 | 41 | 18 | 113.0 | 61,633 | 0 |
...
| `(total)` + relabel-dedup + S | 37 | 39 | 60 | 240.5 | 72,378 | 0 |
...
| `(abel)` + relabel-dedup + S | 50 | 52 | 38 | 1,538.1 | 319,982 | 0 |
...
| `(abel, total)` + relabel-dedup + S | 52 | 52 | 35 | 1,039.2 | 294,036 | 0 |
...
| `(total)` + relabel-dedup + S | 47 | 51 | 272 | 2,778.3 | 411,695 | 0 |
...
| `(abel)` | S vs name, after dedup | 1,000 | 0 / 36 / 5 |
| `(abel)` | S vs name, after dedup | 10,000 | 1 / 45 / 6 |
| `(abel)` | MK vs name, after dedup | 1,000 | 7 / 34 / 0 |
| `(abel)` | MK vs name, after dedup | 10,000 | 8 / 39 / 5 |
| `(abel)` | dedup + S vs shipped | 1,000 | 0 / 36 / 5 |
| `(abel)` | dedup + S vs shipped | 10,000 | 1 / 45 / 6 |
| `(abel)` | dedup + MK vs shipped | 1,000 | 7 / 34 / 0 |
| `(abel)` | dedup + MK vs shipped | 10,000 | 8 / 39 / 5 |
| `(abel, total)` | dedup vs shipped | 1,000 | 0 / 41 / 0 |
| `(abel, total)` | dedup vs shipped | 10,000 | 0 / 52 / 0 |
| `(abel, total)` | S vs name, after dedup | 1,000 | 0 / 40 / 1 |
| `(abel, total)` | S vs name, after dedup | 10,000 | 1 / 50 / 1 |
| `(abel, total)` | MK vs name, after dedup | 1,000 | 1 / 40 / 0 |
| `(abel, total)` | MK vs name, after dedup | 10,000 | 2 / 50 / 0 |
| `(abel, total)` | dedup + S vs shipped | 1,000 | 0 / 40 / 1 |
| `(abel, total)` | dedup + S vs shipped | 10,000 | 1 / 50 / 1 |
| `(abel, total)` | dedup + MK vs shipped | 1,000 | 1 / 40 / 0 |
| `(abel, total)` | dedup + MK vs shipped | 10,000 | 2 / 50 / 0 |
| `(total)` | dedup vs shipped | 1,000 | 0 / 39 / 0 |
| `(total)` | dedup vs shipped | 10,000 | 0 / 49 / 0 |
| `(total)` | S vs name, after dedup | 1,000 | 2 / 35 / 2 |
| `(total)` | S vs name, after dedup | 10,000 | 2 / 47 / 1 |
| `(total)` | MK vs name, after dedup | 1,000 | 0 / 38 / 1 |
| `(total)` | MK vs name, after dedup | 10,000 | 0 / 50 / 0 |
| `(total)` | dedup + S vs shipped | 1,000 | 2 / 35 / 2 |
| `(total)` | dedup + S vs shipped | 10,000 | 2 / 46 / 1 |
| `(total)` | dedup + MK vs shipped | 1,000 | 0 / 38 / 1 |
| `(total)` | dedup + MK vs shipped | 10,000 | 0 / 49 / 0 |
...
|---|---:|---:|---:|---:|---:|
| `(abel)` | 1,000 | 51/60 | 25/60 | 22/60 | 3/60 |
| `(abel, total)` | 1,000 | 48/60 | 6/60 | 3/60 | 1/60 |
| `(total)` | 1,000 | 37/60 | 20/60 | 13/60 | 2/60 |
| `(abel)` | 10,000 | 51/60 | 25/60 | 22/60 | 0/60 |
| `(abel, total)` | 10,000 | 48/60 | 6/60 | 3/60 | 1/60 |
| `(total)` | 10,000 | 37/60 | 20/60 | 13/60 | 2/60 |
