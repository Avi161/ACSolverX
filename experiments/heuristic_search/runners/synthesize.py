...
budgets, so that half is reported as "what actually solved" rather than "what progressed most".
    ...
    python3 -m experiments.heuristic_search.runners.synthesize
"""
import json
import os
import sys
...
from experiments.heuristic_search.core.lab import evaluate, rank, read, score  # noqa: E402
from experiments.heuristic_search.core.perbin import (                  # noqa: E402
