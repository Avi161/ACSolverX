...
most violently, where the state space is widest.
    ...
    python3 -m experiments.heuristic_search.verify.verify_fast [--configs N] [--deadline SEC]
"""
import argparse
import collections
import json
...
from experiments.heuristic_search.core.hlab import RESULTS, load_split       # noqa: E402
from experiments.heuristic_search.core.hfast import search_fast           # noqa: E402
from experiments.heuristic_search.exp.exp02_single import (              # noqa: E402
...
def main():
    ...
    by_id = {}
    from experiments.heuristic_search.core.hlab import cfg_name
    for c in cfgs:
        by_id[cfg_name(c)] = c
