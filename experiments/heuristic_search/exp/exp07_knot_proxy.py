...
reason the proxy is needed and the whole reason it must be validated where it can be.
    ...
    python3 -m experiments.heuristic_search.exp.exp07_knot_proxy
"""
import json
import os
import sys
...
from experiments.heuristic_search.core.lab import evaluate, read, sign_test  # noqa: E402
from experiments.heuristic_search.exp.exp05_cap import top_configs     # noqa: E402
...
def main():
    ...
    # separate anything.
    from experiments.heuristic_search.core.hlab import bench66
