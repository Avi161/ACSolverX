# Frozen engine: copy of hcompact.py at a1d1be23 (the build the campaign runs)
# importing the FROZEN greedy_baseline / hfast kernels beside it (same commit),
# so a change to the live engine or kernels moves the candidate and not this. Do not edit.
...
from experiments.heuristic_search.core.perf_lab.frozen2.greedy_baseline import (  # noqa: E402
    move_to_str,
...
from experiments.heuristic_search.core.perf_lab.frozen2.hfast import (   # noqa: E402
