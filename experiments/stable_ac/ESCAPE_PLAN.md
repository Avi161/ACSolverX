...
> **ARCHIVED RECORD.** This is the plan as written that night, kept unedited as the memory of what was attempted. Of the eight tracks below, only T5 (MITM) and the μ-ladder toolchain built under T1/T3 survive on `research/w5/stable-ac-escape` — T1, T2, T3's probe, T4, T6 and the inflate-and-descend follow-on were pruned. What went, why, and how to get it back: [`../../PRUNED.md`](../../PRUNED.md).
