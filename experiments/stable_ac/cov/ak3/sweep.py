...
Run from the repo root:
    .venv/bin/python3 -m experiments.stable_ac.cov.ak3.sweep
Rows land in results/stable_ac/ak3/sweep_results.jsonl, keyed by the start pair's
...
# Every artifact this experiment produces lives under results/, never beside the code.
RESULTS_DIR = os.path.join(_repo_root(), "results", "stable_ac", "ak3")
OUT_PATH = os.path.join(RESULTS_DIR, "sweep_results.jsonl")
