...
Run from the repo root:
    PYTHONHASHSEED=0 .venv/bin/python3 -m \
        experiments.stable_ac.cov.ak3.certify_classical
...
from experiments.stable_ac.cov.ak3.sweep import AK3, ORBIT2, RESULTS_DIR

CERT_PATH = os.path.join(RESULTS_DIR, "AC17_CERTIFICATE.json")
