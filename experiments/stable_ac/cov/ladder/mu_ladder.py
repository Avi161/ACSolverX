...
CLI:
    .venv/bin/python3 -m experiments.stable_ac.cov.ladder.mu_ladder \
...
from experiments.stable_ac.cov.ladder.mu_descent_scan import (
    find_repo_root,
    hop_outputs,
)
...
def main():
    ...
    from experiments.stable_ac.cov.run.run_cov import _git_commit
