...
| `figures/` | figure and table builders — `cov_summary.py`, `make_figs.py`, `make_escape_fig.py`, `make_nodes_comparison_fig.py`, `rebuild_comparison_tables.py`; their output (`SUMMARY_b*.md`, `per_presentation_b*.csv`, `fig*.png`, `RESULTS.md`) stays under `results/stable_ac/cov/graphs/` |
...
| — | the Colab drivers — `cov_baseline.ipynb`, `mu_ladder_big.ipynb` — moved to [`../../notebooks/stable_ac/`](../../notebooks/stable_ac/) |
