...
CLI (from the repo root):
    .venv/bin/python3 -m experiments.stable_ac.cov.run.run_restart_tree \
...
from experiments.stable_ac.cov.escape.restart_planner import build_restart_plan, abel_magnitude
from experiments.stable_ac.cov.run.run_cov import find_repo_root, _git_commit
