...
| `heuristic_search/` | block/knot **heap orderings** for the greedy. Same moves, same budget, different priority: **17/60 → 30/60** at budget 100. `core/` `exp/` `runners/` `verify/` `splits/` | [→](heuristic_search/README.md) |
