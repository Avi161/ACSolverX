...
| [`stable_ac/abel_top3_ms640_c1of2.ipynb`](stable_ac/abel_top3_ms640_c1of2.ipynb) + [`c2of2`](stable_ac/abel_top3_ms640_c2of2.ipynb) | `experiments.stable_ac.cov.run.abel_top3_run` — the abelian-mass top-3 CoV rule over all 640 ms640 presentations at budget 100,000, early-exiting at the first solve. **One notebook per parallel session**; they differ only in `CHUNK_INDEX`. Method + gates: [`ABEL_TOP3_MS640.md`](../stable_ac/cov/run/ABEL_TOP3_MS640.md) | `results/stable_ac/cov/abel_top3/` |
