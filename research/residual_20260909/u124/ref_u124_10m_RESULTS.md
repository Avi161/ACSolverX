<!-- Copied verbatim from branch codex/ac19-hybrid-10m: results/heuristic_search/u124_10m/RESULTS.md (the 10M-node S20_MK2 run on the 124 unreduced pairs), for the comparison in README.md. -->
