# Copied verbatim from branch experiments/ppo: experiments/stable_ac/cov/ladder/autcanon_fast.py
# (the mu-ladder's Numba Whitehead canonicaliser), so the u124 mu-probe is reproducible from this branch.
