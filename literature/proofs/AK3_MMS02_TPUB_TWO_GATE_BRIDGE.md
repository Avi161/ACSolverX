...
11. the canonical metabelian conjugator has a nontrivial literal defect, and
    no correction in its complete $Q_A''$-coset removes that defect, but other
    metabelian conjugators and full relative paths remain open;
