...
1. **Orient:** read `results/stable_ac/ak3/RESULTS.md` and `results/stable_ac/theory/MU_CRITERION.md`; confirm for yourself that AK(3)'s stable status is OPEN and orbit-2 is classically AC-equivalent to it.
